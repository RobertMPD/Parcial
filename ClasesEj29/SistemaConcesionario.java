...
public class SistemaConcesionario {
    public static void main(String[] args) {
        ...
        System.out.println("Catalogo de vehículos disponibles:");
        for (int i = 0; i < vehiculos.size(); i++) {
            System.out.println((i + 1) + ". " + vehiculos.get(i));
        }

        // seleccion del vehículo
        System.out.print("\nSeleccione el número del vehículo que desea comprar (1 o 2): ");
        ...
        venta.matriculaNuevoVehiculo = "XYZ789"; // matricula generada automáticamente
